...
{	
	...
	public class CameraController : MonoBehaviour, MMEventListener<CorgiEngineEvent>, MMEventListener<MMCameraEvent>
	{
		...
		public virtual void OnCameraShakeEvent(float duration, float amplitude, float frequency, float amplitudeX, float amplitudeY,  float amplitudeZ, bool infinite, MMChannelData channel, bool useUnscaledTime)
		{
